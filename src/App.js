...
const Q_LABELS = {
  ...
  zh: {
    // keyed by English label text (works with database IDs)
    "How difficult was it to focus on tasks today?":    "今天集中精神有多困难？",
    "Did you feel restless or hyperactive?":            "你有感到坐立不安或过度活跃吗？",
    "How often did you act impulsively?":               "你今天冲动行事的频率如何？",
    "Tell me more about how your concentration felt today.": "请告诉我更多关于你今天集中力的感受。",
    "How would you rate your mood today?":              "你今天的心情如何？",
    "Did you feel fatigued or low energy?":             "你今天感到疲惫或精力不足吗？",
    "How was your interest in things you usually enjoy?": "你对平时喜欢的事物有多少兴趣？",
    "In your own words, how are you feeling emotionally today?": "用你自己的话，今天情绪上你感觉如何？",
    "How much were intrusive thoughts bothering you?":  "侵入性想法对你的困扰程度如何？",
    "Did you perform any compulsive behaviours today?": "你今天有进行强迫行为吗？",
    "Can you describe what today was like with your OCD thoughts?": "你能描述今天与强迫症想法的相处吗？",
    "How much did you worry today?":                    "你今天担忧的程度如何？",
    "How restless or on-edge did you feel?":            "你今天感到多烦躁或紧张？",
    "Did you have any panic attacks today?":            "你今天有恐慌发作吗？",
    "How would you describe your anxiety in your own words today?": "用你自己的话描述今天的焦虑感受。",
  },
  ms: {
    "How difficult was it to focus on tasks today?":    "Betapa sukarnya untuk fokus pada tugas hari ini?",
    "Did you feel restless or hyperactive?":            "Adakah anda berasa gelisah atau hiperaktif?",
    "How often did you act impulsively?":               "Seberapa kerap anda bertindak secara impulsif hari ini?",
    "Tell me more about how your concentration felt today.": "Ceritakan lebih lanjut tentang bagaimana tumpuan anda hari ini.",
    "How would you rate your mood today?":              "Bagaimana anda menilai mood anda hari ini?",
    "Did you feel fatigued or low energy?":             "Adakah anda berasa penat atau kurang tenaga?",
    "How was your interest in things you usually enjoy?": "Bagaimana minat anda terhadap perkara yang anda suka?",
    "In your own words, how are you feeling emotionally today?": "Dengan kata-kata anda sendiri, bagaimana perasaan emosi anda hari ini?",
    "How much were intrusive thoughts bothering you?":  "Sejauh mana fikiran mengganggu menyusahkan anda?",
    "Did you perform any compulsive behaviours today?": "Adakah anda melakukan sebarang tingkah laku paksaan hari ini?",
    "Can you describe what today was like with your OCD thoughts?": "Boleh anda ceritakan bagaimana hari ini dengan fikiran OCD anda?",
    "How much did you worry today?":                    "Seberapa banyak anda bimbang hari ini?",
    "How restless or on-edge did you feel?":            "Bagaimana anda berasa gelisah atau tegang hari ini?",
    "Did you have any panic attacks today?":            "Adakah anda mengalami serangan panik hari ini?",
    "How would you describe your anxiety in your own words today?": "Bagaimana anda menggambarkan kebimbangan anda hari ini?",
  },
  ta: {
    "How difficult was it to focus on tasks today?":    "இன்று பணிகளில் கவனம் செலுத்துவது எவ்வளவு கஷ்டமாக இருந்தது?",
    "Did you feel restless or hyperactive?":            "நீங்கள் அமைதியற்றதாக அல்லது அதிக சுறுசுறுப்பாக உணர்ந்தீர்களா?",
    "How often did you act impulsively?":               "இன்று நீங்கள் எவ்வளவு அடிக்கடி தன்னிச்சையாக செயல்பட்டீர்கள்?",
    "Tell me more about how your concentration felt today.": "இன்று உங்கள் கவனம் எப்படி இருந்தது என்று கூறுங்கள்.",
    "How would you rate your mood today?":              "இன்று உங்கள் மனநிலை எப்படி இருந்தது?",
    "Did you feel fatigued or low energy?":             "நீங்கள் சோர்வாக அல்லது குறைந்த ஆற்றலுடன் உணர்ந்தீர்களா?",
    "How was your interest in things you usually enjoy?": "நீங்கள் வழக்கமாக விரும்பும் விஷயங்களில் உங்கள் ஆர்வம் எப்படி இருந்தது?",
    "In your own words, how are you feeling emotionally today?": "உங்கள் சொந்த வார்த்தைகளில், இன்று உணர்வு ரீதியாக நீங்கள் எப்படி உணர்கிறீர்கள்?",
    "How much were intrusive thoughts bothering you?":  "ஊடுருவும் எண்ணங்கள் உங்களை எவ்வளவு தொந்தரவு செய்தன?",
    "Did you perform any compulsive behaviours today?": "இன்று நீங்கள் ஏதேனும் கட்டாய நடத்தைகளை செய்தீர்களா?",
    "Can you describe what today was like with your OCD thoughts?": "இன்று OCD எண்ணங்களுடன் எப்படி இருந்தது என்று விவரிக்க முடியுமா?",
    "How much did you worry today?":                    "இன்று நீங்கள் எவ்வளவு கவலைப்பட்டீர்கள்?",
    "How restless or on-edge did you feel?":            "இன்று நீங்கள் எவ்வளவு அமைதியற்றதாக அல்லது பதட்டமாக உணர்ந்தீர்கள்?",
    "Did you have any panic attacks today?":            "இன்று உங்களுக்கு பீதி தாக்குதல்கள் ஏதேனும் வந்ததா?",
    "How would you describe your anxiety in your own words today?": "இன்று உங்கள் கவலையை உங்கள் சொந்த வார்த்தைகளில் விவரியுங்கள்.",
  },
  th: {
    "How difficult was it to focus on tasks today?":    "วันนี้การจดจ่อกับงานยากแค่ไหน?",
    "Did you feel restless or hyperactive?":            "คุณรู้สึกกระสับกระส่ายหรือไม่อยู่นิ่งไหม?",
    "How often did you act impulsively?":               "วันนี้คุณทำสิ่งต่างๆ โดยไม่คิดบ่อยแค่ไหน?",
    "Tell me more about how your concentration felt today.": "เล่าให้ฟังเพิ่มเติมเกี่ยวกับสมาธิของคุณวันนี้",
    "How would you rate your mood today?":              "วันนี้คุณจะให้คะแนนอารมณ์ของตัวเองอย่างไร?",
    "Did you feel fatigued or low energy?":             "คุณรู้สึกเหนื่อยหรือไม่มีแรงไหม?",
    "How was your interest in things you usually enjoy?": "ความสนใจของคุณในสิ่งที่ชอบเป็นอย่างไรบ้าง?",
    "In your own words, how are you feeling emotionally today?": "ในคำพูดของคุณเอง วันนี้คุณรู้สึกอย่างไรทางอารมณ์?",
    "How much were intrusive thoughts bothering you?":  "ความคิดที่ไม่ต้องการรบกวนคุณมากแค่ไหน?",
    "Did you perform any compulsive behaviours today?": "วันนี้คุณทำพฤติกรรมย้ำคิดย้ำทำไหม?",
    "Can you describe what today was like with your OCD thoughts?": "ช่วยเล่าให้ฟังว่าวันนี้เป็นอย่างไรกับความคิด OCD ของคุณ?",
    "How much did you worry today?":                    "วันนี้คุณวิตกกังวลมากแค่ไหน?",
    "How restless or on-edge did you feel?":            "วันนี้คุณรู้สึกกระวนกระวายหรือตึงเครียดแค่ไหน?",
    "Did you have any panic attacks today?":            "วันนี้คุณมีอาการแพนิคไหม?",
    "How would you describe your anxiety in your own words today?": "ในคำพูดของคุณเอง วันนี้ความวิตกกังวลของคุณเป็นอย่างไร?",
  },
  jv: {
    "How difficult was it to focus on tasks today?":    "Pira angel-e fokus marang tugas dina iki?",
    "Did you feel restless or hyperactive?":            "Apa sampeyan krasa ora bisa meneng utawa hiperaktif?",
    "How often did you act impulsively?":               "Kepiye kerep sampeyan tumindak impulsif dina iki?",
    "Tell me more about how your concentration felt today.": "Critakake luwih akeh babagan konsentrasi sampeyan dina iki.",
    "How would you rate your mood today?":              "Kepiye sampeyan menehi nilai swasana hati dina iki?",
    "Did you feel fatigued or low energy?":             "Apa sampeyan krasa kesel utawa kurang tenaga?",
    "How was your interest in things you usually enjoy?": "Kepiye minat sampeyan marang barang sing biasane diseneng?",
    "In your own words, how are you feeling emotionally today?": "Nganggo tembung sampeyan dhewe, kepiye perasaan emosi sampeyan dina iki?",
    "How much were intrusive thoughts bothering you?":  "Pira pikiran mengganggu kang ngrepoti sampeyan?",
    "Did you perform any compulsive behaviours today?": "Apa sampeyan nindakake perilaku kompulsif dina iki?",
    "Can you describe what today was like with your OCD thoughts?": "Apa sampeyan bisa nggambarake dina iki karo pikiran OCD sampeyan?",
    "How much did you worry today?":                    "Pira sampeyan kuwatir dina iki?",
    "How restless or on-edge did you feel?":            "Kepiye sampeyan krasa gelisah utawa tegang dina iki?",
    "Did you have any panic attacks today?":            "Apa sampeyan ngalami serangan panik dina iki?",
    "How would you describe your anxiety in your own words today?": "Kepiye sampeyan nggambarake rasa kuatir sampeyan dina iki?",
  },
};

// Get translated label for a question — looks up by English label text
// This works regardless of whether IDs are "focus" or "1" or "2" from the DB
function getLabel(q, lang) {
  if (lang === "en") return q.label;
  const langLabels = Q_LABELS[lang];
  if (!langLabels) return q.label;
  // First try by id (for backwards compat), then by label text
  return langLabels[q.id] || langLabels[q.label] || q.label;
}
